export const config = {
  //测试环境使用
  development_base_ip: 'apis.sdcsoft.com.cn', // 'kuaixin.picp.net',
  development_base_port: '',
  //正式环境当中使用  boilermanage.sdcsoft.com.cn
  product_base_ip: 'apis.sdcsoft.com.cn',
  product_base_port: '',
  //设备1）、获得字节数据 （2）、获rl: 'http://output.sdcsoft.com.cn',
  //测试环境-数据报表url
  report_data_url: 'http://192.168.0.103:8083',
  //正式环境-数据报表url
  //report_data_url:'http://report.sdcsoft.com.cn',
ult_home_url: 'https://www.baidu.com',
  //帮助文档地址
